...
@section('head')
    ...
    <style>
        ...
        .category-actions .btn-deactivate:hover {
            background: #fff3cd;
            border-color: #ffc107;
            color: #856404;
        }
            ...
            >
                ...
                <div class="category-card-wrapper">
                    ...
                    <div class="category-actions">
                        ...
                        {{-- غیرفعال کردن تمام سوالات این دسته --}}
...
<script>
    ...
    /* =====================================================
       غیرفعال کردن تمام سوالات یک دسته
    ===================================================== */
    ...
    function deactivateCategorySurveys(categoryId) {
        ...
        const confirmed =
            confirm(
                'آیا از غیرفعال کردن تمام سوالات این دسته مطمئن هستید؟\n\n' +
                'تمام سوالات این دسته به حالت غیرفعال تغییر خواهند کرد.'
            );
        ...
        fetch(
            `{{ url('/admin/survey/category') }}/${categoryId}/deactivate-all`,
            {
                        ...
                        <div class="category-card-wrapper">
                            ...
                            <div class="category-actions">
                                ...
                                <button
                                    type="button"
                                    class="btn btn-edit"
                                    onclick="editCategory(${category.id}, ${JSON.stringify(category.name)})"
                                    title="ویرایش"
                                >
                                    <i class="fas fa-pen"></i>
                                </button>
