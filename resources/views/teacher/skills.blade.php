...
@section('mohtava')
    ...
    <div class="courses-grid" id="coursesGrid">
        @forelse ($courses as $cours)
            ...
            @endphp
            <div class="course-card {{ $isEnded ? 'ended' : '' }}" data-course-id="{{ $cours->id }}"
                data-is-dore="{{ $isDore ? '1' : '0' }}" data-is-private="{{ $isPrivate ? '1' : '0' }}"
                ...
                <div class="course-actions">
                    ...
                    <div class="action-item" data-action="ویرایش"
                        onclick="event.preventDefault(); event.stopPropagation(); editCourse({{ $cours->id }})">
                        <i class="fas fa-edit"></i>
                        <span class="action-tooltip">ویرایش</span>
                    </div>
                    <div class="action-item" data-action="اشتراک گذاری"
                        onclick="event.preventDefault(); event.stopPropagation(); shareCourse({{ $cours->id }})">
                        <i class="fas fa-share-alt"></i>
                        <span class="action-tooltip">اشتراک گذاری</span>
                    </div>
                    <div class="action-item" data-action="آرشیو"
                        onclick="event.preventDefault(); event.stopPropagation(); archiveCourse({{ $cours->id }})">
                        <i class="fas fa-archive"></i>
                        <span class="action-tooltip">آرشیو</span>
                    </div>
                    <!-- دکمه تغییر وضعیت خاتمه یافته/در حال برگزاری (is_ended) -->
                    <div class="action-item" data-action="خاتمه/فعال"
                        onclick="event.preventDefault(); event.stopPropagation(); toggleEnded({{ $cours->id }})">
                    ...
                    <div class="action-item" data-action="عمومی/خصوصی"
                    ...
                    <div class="action-item" data-action="حذف"
                        onclick="event.preventDefault(); event.stopPropagation(); deleteCourse({{ $cours->id }})">
