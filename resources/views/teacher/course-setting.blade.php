    ...
    <div class="settings-container">
        ...
        <form action="/teacher/courses/edit-setting" method="post" enctype="multipart/form-data" id="settingsForm">
            ...
            <div class="accordion-wrapper">
                <!-- ========== بارم بندی ========== -->
                <div
                    class="accordion-item {{ Request::has('open_section') && Request::get('open_section') == 'barmbandi' ? 'active' : '' }}">
                        ...
                        <table class="settings-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="score-input-wrapper">
                                            <input type="number" name="mostamar_nomre" id="mostamar_nomre"
                                                value="{{ $courseSetting->mostamar_nomre }}" class="form-input score-input"
                                                onkeyup="validateScores()" min="0" max="20" step="0.5">
                                    ...
                                    <td>
                                        <div class="score-description-cell">
                                            ...
                                            یک سوم از امتیاز در نظر گرفته شده به «تلاش و فعالیت» و دو سوم آن به «پیشرفت
                                            درسی» اختصاص می‌یابد؛ امتیاز هر دو بخش توسط سیستم و بر اساس میزان تلاش و عملکرد
                                            دانشجو محاسبه خواهد شد.
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="score-input-wrapper">
                                            <input type="number" name="taklif_seminar_nomre" id="taklif_nomre"
                                                value="{{ $courseSetting->taklif_seminar_nomre }}"
                                                class="form-input score-input" onkeyup="validateScores()" min="0" max="20"
                                                step="0.5">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="score-description-cell">
                                            <i class="fas fa-info-circle"></i>
                                            {{ $courseSetting->taklif_seminar_desc ?? 'نمره این بخش بر اساس تعداد تکالیف یا سمینارهایی که دانشجو تا پایان ترم ارائه می دهد، محاسبه خواهد شد.' }}
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="score-input-wrapper">
                                            <input type="number" name="azmon_nomre" id="azmon_nomre"
                                                value="{{ $courseSetting->azmon_nomre }}" class="form-input score-input"
                                                onkeyup="validateScores()" min="0" max="20" step="0.5">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="score-description-cell">
                                            <i class="fas fa-info-circle"></i>
                                            {{ $courseSetting->azmon_desc ?? 'نمرهٔ نهایی بر اساس تعداد آزمون هایی که دانشجو تا پایان ترم شرکت می کند، محاسبه خواهد شد.' }}
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="score-input-wrapper">
                                            <input type="number" name="hozor_ghayab_nomre" id="hozor_ghayab_nomre"
                                                value="{{ $courseSetting->hozor_ghayab_nomre }}"
                                                class="form-input score-input" onkeyup="validateScores()" min="0" max="20"
                                                step="0.5">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="score-description-cell">
                                            <i class="fas fa-info-circle"></i>
                                            حضور و غیاب بر اساس فعالیت‌های دانشجو در هر جلسه محاسبه خواهد شد که شامل ارسال
                                            گزارش و سؤال، داوری و انجام خودآزمایی است. نمرهٔ نهایی در نظر گرفته شده، با توجه
                                            به میزان حضور و مشارکت فعال دانشجو تعیین خواهد شد.
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="score-input-wrapper">
                                            <input type="number" name="miyan_term_nomre" id="miyan_term_nomre"
                                                value="{{ $courseSetting->miyan_term_nomre }}"
                                                class="form-input score-input" onkeyup="validateScores()" min="0" max="20"
                                                step="0.5">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="score-description-cell">
                                            ...
                                            <div class="desc-content">
                                                ...
                                                <a href="/teacher/courses/azmon/list/{{ $course->id }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="score-input-wrapper">
                                            <input type="number" name="kar_amali_nomre" id="kar_amali_nomre"
                                                value="{{ $courseSetting->kar_amali_nomre }}" class="form-input score-input"
                                                onkeyup="validateScores()" min="0" max="20" step="0.5">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="score-description-cell">
                                            <i class="fas fa-info-circle"></i>
                                            اگر نمره‌ای برای این بخش در نظر گرفتید، باید آن را به‌صورت دستی در قسمت «نمرات
                                            دانشجویان» ثبت کنید.
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="score-input-wrapper">
                                            <input type="number" name="payan_term_nomre" id="payan_term_nomre"
                                                value="{{ $courseSetting->payan_term_nomre }}"
                                                class="form-input score-input" onkeyup="validateScores()" min="0" max="20"
                                                step="0.5">
                                            <span class="min-label required">حداقل: ۵</span>
                                        </div>
                                    ...
                                    <td>
                                        <div class="score-description-cell">
                                            ...
                                            <div class="desc-content">
                                                ...
                                                <a href="/teacher/courses/azmon/list/{{ $course->id }}"
                                                    class="definition-link payan">
                                                    <i class="fas fa-plus-circle"></i>
                                                    <span class="link-text">تعریف آزمون</span>
                                                    <span class="link-arrow">←</span>
                                                    <span class="link-highlight">پایان‌ترم</span>
                                                </a>
                                                را انتخاب کنید. در غیر این صورت، نمرهٔ پایان‌ترم را باید به‌صورت دستی در
                                                قسمت «نمرات دانشجویان» وارد کنید.
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <div class="total-score" id="totalScoreBox">
                            <span class="score-text">
                                مجموع نمرات : <span id="majmo">
                                    {{ $courseSetting->mostamar_nomre + $courseSetting->taklif_seminar_nomre + $courseSetting->azmon_nomre + $courseSetting->hozor_ghayab_nomre + $courseSetting->miyan_term_nomre + $courseSetting->kar_amali_nomre + $courseSetting->payan_term_nomre }}
                                </span> از ۲۰
                            </span>
                        ...
                        <table class="settings-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <label class="toggle-switch">
                                            <input type="checkbox" name="soal_last" {{ $courseSetting->soal_last ? 'checked' : '' }}>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="toggle-switch">
                                            <input type="checkbox" name="gozaresh_last" {{ $courseSetting->gozaresh_last ? 'checked' : '' }}>
                                            <span class="toggle-slider"></span>
                                        </label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <label class="toggle-switch">
                                            <input type="checkbox" name="taklif_last" {{ $courseSetting->taklif_last ? 'checked' : '' }}>
                                            <span class="toggle-slider"></span>
                                        </label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>تعداد جلسات</td>
                                    <td>
                                        <input type="number" name="jalasat" value="{{ $courseSetting->jalasat }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" name="max_soal" value="{{ $courseSetting->max_soal }}"
                                            class="form-input" min="1">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input type="tel" name="daily_judgment_limit" id="daily_judgment_limit"
                                            value="{{ old('daily_judgment_limit', $courseSetting->daily_judgment_limit) }}"
                                            class="form-input" style="max-width: 150px;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea name="tarahi_soal_desc" class="form-textarea"
                                            rows="3">{{ $courseSetting->tarahi_soal_desc }}</textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td>هدایت دانشجو در بخش ارسال گزارش</td>
                                    <td>
                                        <textarea name="ersal_gozaresh_desc"  class="form-textarea">
                {{ $courseSetting->ersal_gozaresh_desc ?? $siteSetting->ersal_gozaresh_desc ?? 'موضوع اصلی این جلسه چه بود و چه هدفی داشت؟ لطفاً یک نکتهٔ آموزنده از مطالب ارائه شده را با بیانی دیگر (به زبان خودتان) بازنویسی کنید.' }}
            </textarea>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <table class="settings-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" name="min_w_khod" value="{{ $courseSetting->min_w_khod }}"
                                            class="form-input" min="1">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" name="q_num" id="q_num" value="{{ $courseSetting->q_num }}"
                                            class="form-input" min="1">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <select name="sath_khod" class="form-select">
                                            <option value="1" {{ $courseSetting->sath_khod == 1 ? 'selected' : '' }}>عالی
                                            </option>
                                            <option value="2" {{ $courseSetting->sath_khod == 2 ? 'selected' : '' }}>عالی و
                                                خوب</option>
                                            <option value="3" {{ $courseSetting->sath_khod == 3 ? 'selected' : '' }}>خوب
                                            </option>
                                        </select>
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                        <div style="display: flex; align-items: center; gap: 12px;">
                                            <label class="toggle-switch">
                                                ...
                                                <input type="checkbox" name="natije" value="1" {{ $courseSetting->natije ? 'checked' : '' }} class="toggle-text" data-target="natije-text">
                                                <span class="toggle-slider"></span>
                                            </label>
                                            <span id="natije-text"
                                                class="toggle-label">{{ $courseSetting->natije ? 'بله' : 'خیر' }}</span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div style="display: flex; align-items: center; gap: 12px;">
                                            <label class="toggle-switch">
                                                ...
                                                <input type="checkbox" name="show_quiz" value="1" {{ $courseSetting->show_quiz ? 'checked' : '' }} class="toggle-text"
                                                    data-target="quiz-text">
                                                <span class="toggle-slider"></span>
                                            </label>
                                            <span id="quiz-text"
                                                class="toggle-label">{{ $courseSetting->show_quiz ? 'بله' : 'خیر' }}</span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div style="display: flex; align-items: center; gap: 12px;">
                                            <label class="toggle-switch">
                                                ...
                                                <input type="checkbox" name="time_limit_khod" id="timeToggle" value="1" {{ $courseSetting->time_limit_khod ? 'checked' : '' }} class="toggle-text"
                                                    data-target="time-limit-text">
                                                <span class="toggle-slider"></span>
                                            </label>
                                            <span id="time-limit-text"
                                                class="toggle-label">{{ $courseSetting->time_limit_khod ? 'فعال' : 'غیرفعال' }}</span>
                                        </div>
                                    </td>
                                </tr>
                                <tr id="time-settings-row" class="time-settings-row">
                                    <td colspan="2" style="padding: 0;">
                                        <div class="quiz-time-section {{ $courseSetting->time_limit_khod ? 'active' : '' }}"
                                            id="timeSection">
                                            <div class="section-header">
                                                <i class="fas fa-clock"></i>
                                                <span>تنظیمات محدودیت زمانی</span>
                                                <span class="badge-time"
                                                    id="statusBadge">{{ $courseSetting->time_limit_khod ? 'فعال' : 'غیرفعال' }}</span>
                                            </div>

                                            <div class="quiz-time-type" id="timeTypeGroup"
                                                style="{{ $courseSetting->time_limit_khod ? '' : 'opacity: 0.5; pointer-events: none;' }}">
                                                <label
                                                    class="time-option {{ ($courseSetting->time_per_question > 0 && $courseSetting->total_time_limit == 0) || ($courseSetting->time_per_question == 0 && $courseSetting->total_time_limit == 0) ? 'selected' : '' }}"
                                                    id="perQuestionOption">
                                                    <input type="radio" name="time_type" value="per_question" {{ ($courseSetting->time_per_question > 0 && $courseSetting->total_time_limit == 0) || ($courseSetting->time_per_question == 0 && $courseSetting->total_time_limit == 0) ? 'checked' : '' }}>
                                                ...
                                                <label
                                                    class="time-option {{ $courseSetting->total_time_limit > 0 ? 'selected' : '' }}"
                                                    id="totalOption">
                                                    <input type="radio" name="time_type" value="total" {{ $courseSetting->total_time_limit > 0 ? 'checked' : '' }}>
                                            ...
                                            <div id="per-question-time"
                                                class="quiz-time-input {{ ($courseSetting->time_per_question > 0 && $courseSetting->total_time_limit == 0) || ($courseSetting->time_per_question == 0 && $courseSetting->total_time_limit == 0) ? 'visible' : '' }}"
                                                style="{{ $courseSetting->time_limit_khod ? '' : 'opacity: 0.5;' }}">
                                                <div class="input-row">
                                                    <label>زمان هر سوال:</label>
                                                    <input type="number" name="time_per_question" id="time_per_question"
                                                        value="{{ $courseSetting->time_per_question > 0 ? $courseSetting->time_per_question : 45 }}"
                                                        class="form-input" min="10" max="300" {{ $courseSetting->time_limit_khod ? '' : 'disabled' }}>
                                                ...
                                                <div class="quiz-time-calc">
                                                    ...
                                                    زمان کل آزمون ≈
                                                    <strong
                                                        id="total-time-calc">{{ round((($courseSetting->q_num) * ($courseSetting->time_per_question > 0 ? $courseSetting->time_per_question : 45)) / 60) }}</strong>
                                                    دقیقه
                                                    <span class="calc-result" id="perQuestionResult">
                                                        {{ $courseSetting->time_per_question > 0 ? $courseSetting->time_per_question : 45 }}
                                                        ثانیه {{ $courseSetting->q_num }} X سوال
                                                    </span>
                                                </div>
                                            </div>

                                            <div id="total-time"
                                                class="quiz-time-input {{ $courseSetting->total_time_limit > 0 ? 'visible' : '' }}"
                                                style="{{ $courseSetting->time_limit_khod ? '' : 'opacity: 0.5;' }}">
                                                <div class="input-row">
                                                    <label>زمان کل آزمون:</label>
                                                    <input type="number" name="total_time_limit" id="total_time_limit"
                                                        value="{{ $courseSetting->total_time_limit > 0 ? $courseSetting->total_time_limit : round((($courseSetting->q_num) * 45) / 60) }}"
                                                        class="form-input" min="1" max="120" {{ $courseSetting->time_limit_khod ? '' : 'disabled' }}>
                                                ...
                                                <div class="quiz-time-calc">
                                                    ...
                                                    <strong
                                                        id="avg-time-per-question">{{ round((($courseSetting->total_time_limit > 0 ? $courseSetting->total_time_limit : round((($courseSetting->q_num) * 45) / 60)) * 60) / ($courseSetting->q_num)) }}</strong>
                                                    ثانیه
                                                    <span class="calc-result" id="totalResult">
                                                        {{ $courseSetting->total_time_limit > 0 ? $courseSetting->total_time_limit : round((($courseSetting->q_num) * 45) / 60) }}
                                                        دقیقه
                                                    </span>
                                                </div>
                                            </div>
                        ...
                        <div class="visibility-grid">
                            <div class="vis-item">
                                <label class="switch-label">
                                    ...
                                    <div class="switch">
                                        <input type="checkbox" class="vis-checkbox" data-field="active" id="visActive" {{ $course->active ? 'checked' : '' }}>
                            ...
                            <div class="vis-item">
                                <label class="switch-label">
                                    ...
                                    <div class="switch">
                                        <input type="checkbox" class="vis-checkbox" data-field="davari" id="visDavari" {{ $course->davari ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </div>
                                </label>
                            </div>
                            <div class="vis-item">
                                <label class="switch-label">
                                    ...
                                    <div class="switch">
                                        <input type="checkbox" class="vis-checkbox" data-field="quiz" id="visQuiz" {{ $course->quiz ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </div>
                                </label>
                            </div>
                            <div class="vis-item">
                                <label class="switch-label">
                                    ...
                                    <div class="switch">
                                        <input type="checkbox" class="vis-checkbox" data-field="faaliat" id="visFaaliat" {{ $course->faaliat ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </div>
                                </label>
                            </div>
                            <div class="vis-item">
                                <label class="switch-label">
                                    ...
                                    <div class="switch">
                                        <input type="checkbox" class="vis-checkbox" data-field="pishraft" id="visPishraft"
...
@section('js')
    ...
    <script>
        // ========== ذخیره‌سازی داده‌های siteSetting به‌عنوان متغیر جاوااسکریپت ==========
        var siteSettings = @json($siteSetting);
        ...
        function validateScores() {
            ...
            if (total !== 20) {
                errorMessages.push(total > 20 ? 'مجموع نمرات نمی‌تواند از ۲۰ بیشتر باشد (مجموع فعلی: ' + total + ')' : 'مجموع نمرات باید دقیقاً برابر با ۲۰ باشد (مجموع فعلی: ' + total + ')');
        ...
        // ========== بارم بندی پیش فرض (از siteSettings) ==========
        function setDefaultScore() {
            document.getElementById('mostamar_nomre').value = siteSettings.mostamar_nomre || 12;
            document.getElementById('taklif_nomre').value = siteSettings.taklif_seminar_nomre || 0;
            document.getElementById('azmon_nomre').value = siteSettings.azmon_nomre || 0;
            document.getElementById('hozor_ghayab_nomre').value = siteSettings.hozor_ghayab_nomre || 0;
            document.getElementById('miyan_term_nomre').value = siteSettings.miyan_term_nomre || 0;
            document.getElementById('kar_amali_nomre').value = siteSettings.kar_amali_nomre || 0;
            document.getElementById('payan_term_nomre').value = siteSettings.payan_term_nomre || 8;
            validateScores();
            showToast('success', 'بارم بندی به حالت پیش فرض (بر اساس تنظیمات سراسری) تنظیم شد');
        }

        // ========== فعالیت‌های پیش فرض (از siteSettings) ==========
        function setDefaultActivities() {
            // چک‌باکس‌ها
            document.querySelector('input[name="soal_last"]').checked = !!siteSettings.soal_last;
            document.querySelector('input[name="gozaresh_last"]').checked = !!siteSettings.gozaresh_last;
            document.querySelector('input[name="taklif_last"]').checked = !!siteSettings.taklif_last;
            ...
            // توضیحات متنی
            document.querySelector('textarea[name="tarahi_soal_desc"]').value = siteSettings.tarahi_soal_desc || 'یک سؤال خلاقانه طراحی کنید که به یادگیری دوستانتان کمک کند و به نام خودتان منتشر شود. قبل از ارسال، حتماً سؤالاتی که دیگران طرح کرده اند را مرور کنید تا از تکراری نبودن سوال خود مطمئن شوید.';
            document.querySelector('textarea[name="ersal_gozaresh_desc"]').value = siteSettings.ersal_gozaresh_desc || 'یک سؤال خلاقانه طراحی کنید که به یادگیری دوستانتان کمک کند و به نام خودتان منتشر شود. قبل از ارسال، حتماً سؤالاتی که دیگران طرح کرده اند را مرور کنید تا از تکراری نبودن سوال خود مطمئن شوید.';

            // تنظیمات خودآزمایی
            document.querySelector('input[name="min_w_khod"]').value = siteSettings.min_w_khod || 14;
            document.querySelector('input[name="q_num"]').value = siteSettings.q_num || 10;
            document.querySelector('select[name="sath_khod"]').value = siteSettings.sath_khod || 1;

            // چک‌باکس‌های خودآزمایی
            document.querySelector('input[name="natije"]').checked = !!siteSettings.natije;
            document.querySelector('input[name="show_quiz"]').checked = !!siteSettings.show_quiz;
            document.querySelector('input[name="time_limit_khod"]').checked = !!siteSettings.time_limit_khod;

            // زمان‌ها
            document.querySelector('input[name="time_per_question"]').value = siteSettings.time_per_question || 45;
            document.querySelector('input[name="total_time_limit"]').value = siteSettings.total_time_limit || Math.round((siteSettings.q_num || 10) * 45 / 60);

            // رادیو time_type
            var timeType = siteSettings.time_type || 'per_question';
            var radio = document.querySelector('input[name="time_type"][value="' + timeType + '"]');
            if (radio) radio.checked = true;

            // به‌روزرسانی محاسبات زمانی و وضعیت نمایش
            updateTimeCalculations();
            if (siteSettings.time_limit_khod) {
                toggleTimeSettings();
            }

            showToast('success', 'فعالیت‌ها به حالت پیش فرض (بر اساس تنظیمات سراسری) تنظیم شدند');
        }
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            checkboxes.forEach(checkbox => {
                checkbox.addEventListener('change', function () {
                    ...
                    if (switchContainer) switchContainer.classList.add('loading');
                    this.disabled = true;
                    fetch(`/teacher/courses/toggle-visibility/${courseId}`, {
                        ...
                        .finally(() => {
                            if (switchContainer) switchContainer.classList.remove('loading');
                            this.disabled = false;
                        });
                });
            });
        ...
        function showToast(type, message) {
            ...
            toast.innerHTML = `<i class="fas ${type === 'success' ? 'fa-check-circle' : type === 'warning' ? 'fa-exclamation-triangle' : 'fa-exclamation-circle'}"></i><span>${message}</span>`;
        ...
        // ========== مدیریت محدودیت زمانی خودآزمایی ==========
        function initializeTimeSettings() {
            ...
            if (perQuestionInputField) {
                ...
                if (val < 10) perQuestionInputField.value = 10;
        ...
        function updateTimeCalculations() {
            ...
            const timeToggle = document.getElementById('timeToggle');
            if (!timeToggle || !timeToggle.checked) return;
        ...
        document.addEventListener('DOMContentLoaded', function () {
            document.getElementById('settingsForm').addEventListener('submit', function (e) {
                if (!validateScores()) {
                    ...
                    document.getElementById('scoreValidationError').scrollIntoView({ behavior: 'smooth', block: 'center' });
                }
            });
        });
    </script>
