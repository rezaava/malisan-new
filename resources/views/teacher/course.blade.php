...
@section('head')
    ...
    <style>
        ...
        /* ثابت ماندن قسمت بالای فرم هنگام اسکرول */
        #sessionModal .modal-box {
            max-height: 90vh;
            overflow-y: auto;
            overflow-x: hidden;
        }
        ...
        #sessionModal .modal-form {
            position: relative;
        }

        /* =========================================
           انتخاب نوع محتوای درس
           ========================================= */
        ...
        .content-choice-label:hover {
            border-color: #1e6f9f;
            background: #f8fbff;
        }

        .content-choice-label input[type="radio"] {
            width: 18px;
            height: 18px;
            margin: 0;
            cursor: pointer;
        ...
        .content-choice-label i {
            color: #1e6f9f;
            font-size: 17px;
        }

        .content-choice-label span {
            flex: 1;
        }

        .content-choice-item.selected .content-choice-label {
            border-color: #1e6f9f;
            background: #f0f7ff;
            box-shadow: 0 2px 8px rgba(30,111,159,.08);
        }
        ...
        .content-option-box.active {
            display: block;
        }

        /* دو فیلد لینک کلاس و آپارات در یک ردیف */
        .video-links-row {
            display: flex;
            gap: 15px;
            width: 100%;
                    ...
                    <div class="collapsible-header">
                        ...
                        <div style="margin-right:auto;">
                            ...
                            <a
                                ...
                                style="
                                    display:{{ $sessions->isNotEmpty() && !empty($sessions->first()->majazi) ? 'inline-flex' : 'none' }};
                                    text-decoration:none;
                                    cursor:pointer;
                                "
                            >
                        ...
                        <div class="pdf-toolbar d-flex justify-content-between align-items-center w-100">
                            ...
                            <div class="w-100">
                                ...
                                <a
                                    ...
                                    style="
                                        float:left;
                                        {{ $sessions->isNotEmpty() && $sessions->first()->file
                                            ? 'display:inline-flex;'
                                            : 'display:none;' }}
                                    "
                                >
            ...
            <div class="content-frame">
                ...
                <div class="content-frame-body">
                    ...
                    <div class="form-group">
                        ...
                        <label>
                            <i class="fas fa-align-right" style="color:#1e6f9f;"></i>
                            محتوای درس (اختیاری)
                        </label>
                    ...
                    {{-- انتخاب بین لینک و فایل --}}

                    <div class="form-group">

                        <label style="margin-bottom:10px;">
                            <i class="fas fa-exchange-alt" style="color:#1e6f9f;"></i>
                            روش ارائه محتوای درس
                        </label>
                    ...
                    {{-- لینک کلاس مجازی و آپارات در یک ردیف --}}
                    ...
                    <div class="video-links-row">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                id="modalAparat"
                                value="{{ old('aparat') }}"
                                placeholder="کد اسکریپت آپارات را به همراه iframe  کپی کنید"
                            >
...
function openModal(mode,sessionId=null){
    ...
    if(mode==='create'){
        ...
        /*
         * در ایجاد جلسه، هیچ‌کدام از دو روش
         * به صورت پیش‌فرض انتخاب نمی‌شوند.
         */
...
function fetchSessionData(sessionId){
    ...
    .then(data=>{
        ...
        if(data.success){
            ...
            /*
             * تعیین خودکار نوع محتوا هنگام ویرایش
             */
...
function changeSession(
    ...
    const sessionLessonPlan=
        document.getElementById('sessionLessonPlan');
    ...
    if(pdfViewer){
        ...
        if(fullPdfUrl){
            ...
            newObject.innerHTML=
                '<object width="100%" height="550" data="'+
                fullPdfUrl+
                '"></object>';
    ...
    const questionTeacherBtn=
        document.getElementById('questionTeacherBtn');
    ...
    const homeworkTeacherBtn=
        document.getElementById('homeworkTeacherBtn');
...
document.getElementById('profExModal').addEventListener(
    'click',
    function(e){
...
document.getElementById('editReportModal').addEventListener(
    'click',
    function(e){
...
document.addEventListener('DOMContentLoaded',function(){
    ...
    const editorElement=
        document.getElementById('modalEditor');


    if(editorElement){

        joditEditor=new Jodit(
            '#modalEditor',
            {
                width:'100%',
                height:200,
    ...
    const lessonPlanElement=
        document.getElementById('modalLessonPlan');


    if(lessonPlanElement){

        joditLessonPlan=new Jodit(
            '#modalLessonPlan',
            {
                width:'100%',
                height:180,
    ...
    const reportEditorElement=
        document.getElementById('reportDescEditor');


    if(reportEditorElement){

        reportJoditEditor=new Jodit(
            '#reportDescEditor',
            {
                width:'100%',
                height:250,
    ...
    const fileInput=
        document.getElementById('modalFileUpload');
        ...
        fileInput.addEventListener(
            ...
            function(e){
                ...
                if(e.target.files[0]){
                    ...
                    /*
                     * با انتخاب فایل، خودکار
                     * حالت بارگذاری فعال می‌شود.
                     */
